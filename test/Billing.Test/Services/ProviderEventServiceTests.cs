        ...
        await _providerInvoiceItemRepository
            ...
            .CreateAsync(
                Arg.Is<ProviderInvoiceItem>(options =>
                    ...
                    && options.Total
                        == options.AssignedSeats * teamsPlan.PasswordManager.ProviderPortalSeatPrice * 0.65M
                )
            );
        ...
        await _providerInvoiceItemRepository
            ...
            .CreateAsync(
                Arg.Is<ProviderInvoiceItem>(options =>
                    ...
                    && options.UsedSeats == 30
                    && options.Total
                        == options.AssignedSeats * enterprisePlan.PasswordManager.ProviderPortalSeatPrice * 0.65M
                )
            );
