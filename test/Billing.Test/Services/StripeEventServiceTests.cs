...
public class StripeEventServiceTests
{
    ...
    public async Task GetCustomer_Fresh_Expand_ReturnsAPICustomer()
    {
        ...
        _stripeFacade
            .GetCustomer(apiCustomer.Id, Arg.Is<CustomerGetOptions>(options => options.Expand == expand))
            .Returns(apiCustomer);
    ...
    public async Task GetInvoice_Fresh_Expand_ReturnsAPIInvoice()
    {
        ...
        _stripeFacade
            .GetInvoice(apiInvoice.Id, Arg.Is<InvoiceGetOptions>(options => options.Expand == expand))
            .Returns(apiInvoice);
    ...
    public async Task ValidateCloudRegion_SubscriptionUpdated_Success()
    {
        ...
        _stripeFacade.GetSubscription(subscription.Id, Arg.Any<SubscriptionGetOptions>()).Returns(subscription);
