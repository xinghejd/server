...
public class OrganizationSponsorshipsControllerTests
{
    ...
    [Theory]
    [BitAutoData]
    public async Task RedeemSponsorship_BadToken_ThrowsBadRequest(
    ...
    )
    {
        ...
        await sutProvider
            .GetDependency<ISetUpSponsorshipCommand>()
    ...
    [Theory]
    [BitAutoData]
    public async Task RedeemSponsorship_NotSponsoredOrgOwner_ThrowsBadRequest(
        string sponsorshipToken,
        User user,
    ...
    )
    {
        ...
        sutProvider
            .GetDependency<IValidateRedemptionTokenCommand>()
            .ValidateRedemptionTokenAsync(sponsorshipToken, user.Email)
            .Returns((true, sponsorship));
        sutProvider
            .GetDependency<ICurrentContext>()
            .OrganizationOwner(model.SponsoredOrganizationId)
            .Returns(false);
    ...
    [Theory]
    [BitAutoData]
    public async Task RedeemSponsorship_NotSponsoredOrgOwner_Success(
        string sponsorshipToken,
        User user,
        OrganizationSponsorship sponsorship,
    ...
    )
    {
        ...
        sutProvider
            ...
            .GetByIdAsync(model.SponsoredOrganizationId)
            .Returns(sponsoringOrganization);
    ...
    [Theory]
    [BitAutoData]
    public async Task PreValidateSponsorshipToken_ValidatesToken_Success(
        string sponsorshipToken,
        User user,
        OrganizationSponsorship sponsorship,
        SutProvider<OrganizationSponsorshipsController> sutProvider
    ...
    [Theory]
    [BitAutoData]
    public async Task RevokeSponsorship_WrongSponsoringUser_ThrowsBadRequest(
    ...
    )
    {
        ...
        sutProvider
            ...
            .GetByIdAsync(sponsoringOrgUser.Id)
        ...
        await sutProvider
            .GetDependency<IRemoveSponsorshipCommand>()
            .DidNotReceiveWithAnyArgs()
    ...
    [Theory]
    [BitAutoData]
    public async Task RemoveSponsorship_WrongOrgUserType_ThrowsBadRequest(
