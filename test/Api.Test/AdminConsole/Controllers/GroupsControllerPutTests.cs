...
public class GroupsControllerPutTests
{
    [Theory]
    [BitAutoData]
    public async Task Put_WithAdminAccess_Success(
        Organization organization,
        Group group,
        GroupRequestModel groupRequestModel,
        List<CollectionAccessSelection> existingCollectionAccess,
    ...
    )
    {
        ...
        sutProvider
            ...
            .AuthorizeAsync(
                ...
                Arg.Is<IEnumerable<IAuthorizationRequirement>>(reqs =>
                    reqs.Contains(BulkCollectionOperations.ModifyGroupAccess)
                )
            )
        ...
        await sutProvider
            ...
            .Received(1)
            .UpdateGroupAsync(
                Arg.Is<Group>(g => g.OrganizationId == organization.Id && g.Name == groupRequestModel.Name),
                ...
                Arg.Is<IEnumerable<Guid>>(guids =>
                    guids.ToHashSet().SetEquals(groupRequestModel.Users.ToHashSet())
                )
            );
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_UpdateMembers_NoAdminAccess_CannotAddSelfToGroup(
        Organization organization,
        Group group,
        GroupRequestModel groupRequestModel,
        OrganizationUser savingUser,
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_UpdateMembers_NoAdminAccess_AlreadyInGroup_Success(
        Organization organization,
        Group group,
        GroupRequestModel groupRequestModel,
        OrganizationUser savingUser,
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_UpdateMembers_WithAdminAccess_CanAddSelfToGroup(
        Organization organization,
        Group group,
        GroupRequestModel groupRequestModel,
        OrganizationUser savingUser,
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_UpdateMembers_NoAdminAccess_ProviderUser_Success(
        Organization organization,
        Group group,
        GroupRequestModel groupRequestModel,
        List<Guid> currentGroupUsers,
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_UpdateCollections_DoesNotOverwriteUnauthorizedCollections(
        GroupRequestModel groupRequestModel,
        Group group,
        Organization organization,
        SutProvider<GroupsController> sutProvider,
    ...
    )
    {
        ...
        sutProvider
            ...
            .AuthorizeAsync(
                Arg.Any<ClaimsPrincipal>(),
                Arg.Is<Collection>(c => c.Id == editedCollectionId),
                Arg.Is<IEnumerable<IAuthorizationRequirement>>(reqs =>
                    reqs.Contains(BulkCollectionOperations.ModifyGroupAccess)
                )
            )
        ...
        sutProvider
            ...
            .AuthorizeAsync(
                Arg.Any<ClaimsPrincipal>(),
                Arg.Is<Collection>(c => c.Id == readonlyCollectionId1 || c.Id == readonlyCollectionId2),
                Arg.Is<IEnumerable<IAuthorizationRequirement>>(reqs =>
                    reqs.Contains(BulkCollectionOperations.ModifyGroupAccess)
                )
            )
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_UpdateCollections_ThrowsIfSavingUserCannotUpdateCollections(
        GroupRequestModel groupRequestModel,
        Group group,
        Organization organization,
        SutProvider<GroupsController> sutProvider,
    ...
    )
    {
        ...
        sutProvider
            ...
            .AuthorizeAsync(
                Arg.Any<ClaimsPrincipal>(),
                Arg.Is<Collection>(c => postedCollectionIds.Contains(c.Id)),
                Arg.Is<IEnumerable<IAuthorizationRequirement>>(reqs =>
                    reqs.Contains(BulkCollectionOperations.ModifyGroupAccess)
                )
            )
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_UpdateCollections_ThrowsIfSavingUserCannotAddCollections(
        GroupRequestModel groupRequestModel,
        Group group,
        Organization organization,
        SutProvider<GroupsController> sutProvider,
    ...
    )
    {
        ...
        sutProvider
            ...
            .Returns(savingUser?.UserId ?? CoreHelpers.GenerateComb());
        ...
        sutProvider
            ...
            .Returns(
                new Tuple<Group, ICollection<CollectionAccessSelection>>(group, currentCollectionAccess ?? [])
            );
        if (savingUser != null)
        {
            sutProvider
                .GetDependency<IOrganizationUserRepository>()
                .GetByOrganizationAsync(orgId, savingUser.UserId!.Value)
                .Returns(savingUser);
        }
        ...
        sutProvider
            ...
            .Returns(callInfo =>
                callInfo.Arg<IEnumerable<Guid>>().Select(guid => new Collection { Id = guid }).ToList()
            );
    }
}
