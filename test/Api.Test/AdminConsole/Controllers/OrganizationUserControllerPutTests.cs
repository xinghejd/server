...
public class OrganizationUserControllerPutTests
{
    ...
    )
    {
        ...
        await sutProvider
            .GetDependency<IUpdateOrganizationUserCommand>()
            .Received(1)
            .UpdateUserAsync(
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_NoAdminAccess_CannotAddSelfToCollections(
        OrganizationUserUpdateRequestModel model,
        OrganizationUser organizationUser,
        OrganizationAbility organizationAbility,
        SutProvider<OrganizationUsersController> sutProvider,
    ...
    )
    {
        ...
        var exception = await Assert.ThrowsAsync<BadRequestException>(
            async () => await sutProvider.Sut.Put(organizationAbility.Id, organizationUser.Id, model)
        );
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_NoAdminAccess_CannotAddSelfToGroups(
        OrganizationUserUpdateRequestModel model,
        OrganizationUser organizationUser,
        OrganizationAbility organizationAbility,
        SutProvider<OrganizationUsersController> sutProvider,
    ...
    [Theory]
    [BitAutoData]
    public async Task Put_WithAdminAccess_CanAddSelfToGroups(
        OrganizationUserUpdateRequestModel model,
        OrganizationUser organizationUser,
        OrganizationAbility organizationAbility,
        SutProvider<OrganizationUsersController> sutProvider,
    ...
    )
    {
        ...
        sutProvider
            ...
            .Returns(
                new Tuple<OrganizationUser, ICollection<CollectionAccessSelection>>(
                    organizationUser,
