...
public class EmergencyAccessRotationValidatorTests
{
    ...
    public async Task ValidateAsync_MissingEmergencyAccess_Throws(
        SutProvider<EmergencyAccessRotationValidator> sutProvider,
        User user,
    ...
    )
    {
        ...
        var userEmergencyAccess = emergencyAccessKeys
            .Select(e => new EmergencyAccessDetails
            {
                Id = e.Id,
        ...
        await Assert.ThrowsAsync<BadRequestException>(
            async () => await sutProvider.Sut.ValidateAsync(user, emergencyAccessKeys)
        );
    }
    ...
    )
    {
        ...
        await Assert.ThrowsAsync<BadRequestException>(
            async () =>
                await sutProvider.Sut.ValidateAsync(user, Enumerable.Empty<EmergencyAccessWithIdRequestModel>())
        );
    }
}
