...
public class ServiceAccountsControllerTests
{
    ...
    )
    {
        ...
        await sutProvider
            .GetDependency<IServiceAccountSecretsDetailsQuery>()
            .Received(1)
    ...
    [Theory]
    [BitAutoData]
    public async Task GetServiceAccountsByOrganization_Success(
        SutProvider<ServiceAccountsController> sutProvider,
    ...
    )
    {
        ...
        sutProvider
            .GetDependency<IServiceAccountSecretsDetailsQuery>()
            .GetManyByOrganizationIdAsync(default, default, default, default)
            .ReturnsForAnyArgs(new List<ServiceAccountSecretsDetails> { resultServiceAccount });

        var result = await sutProvider.Sut.ListByOrganizationAsync(
            resultServiceAccount.ServiceAccount.OrganizationId
        );
        ...
        await sutProvider
            ...
            .Received(1)
            .GetManyByOrganizationIdAsync(
                Arg.Is(AssertHelper.AssertPropertyEqual(resultServiceAccount.ServiceAccount.OrganizationId)),
                Arg.Any<Guid>(),
                Arg.Any<AccessClientType>(),
                Arg.Any<bool>()
            );
    ...
    )
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() => sutProvider.Sut.ListByOrganizationAsync(orgId));
    }

    [Theory]
    [BitAutoData]
    public async Task CreateServiceAccount_NoAccess_Throws(
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccountCreateRequestModel data,
        Guid organizationId
    )
    {
        sutProvider
            ...
            .AuthorizeAsync(
                ...
                data.ToServiceAccount(organizationId),
        ...
        sutProvider
            .GetDependency<ICreateServiceAccountCommand>()
    ...
    [BitAutoData(1)]
    [BitAutoData(2)]
    public async Task CreateServiceAccount_WhenAutoscalingRequired_CallsUpdateSubscription(
        int newSlotsRequired,
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccountCreateRequestModel data,
        Organization organization
    ...
    [Theory]
    [BitAutoData]
    public async Task CreateServiceAccount_Success(
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccountCreateRequestModel data,
        Guid organizationId,
    ...
    [Theory]
    [BitAutoData]
    public async Task UpdateServiceAccount_NoAccess_Throws(
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccountUpdateRequestModel data,
    ...
    )
    {
        sutProvider
            ...
            .AuthorizeAsync(
                Arg.Any<ClaimsPrincipal>(),
                data.ToServiceAccount(existingServiceAccount.Id),
                Arg.Any<IEnumerable<IAuthorizationRequirement>>()
            )
            .ReturnsForAnyArgs(AuthorizationResult.Failed());
        sutProvider
        ...
        sutProvider
            .GetDependency<IUpdateServiceAccountCommand>()
            .UpdateAsync(default)
            .ReturnsForAnyArgs(resultServiceAccount);

        await Assert.ThrowsAsync<NotFoundException>(
            () => sutProvider.Sut.UpdateAsync(existingServiceAccount.Id, data)
        );
        await sutProvider
            .GetDependency<IUpdateServiceAccountCommand>()
            .DidNotReceiveWithAnyArgs()
    ...
    [Theory]
    [BitAutoData]
    public async Task UpdateServiceAccount_Success(
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccountUpdateRequestModel data,
        ServiceAccount existingServiceAccount
    )
    ...
    [Theory]
    [BitAutoData]
    public async Task CreateAccessToken_NoAccess_Throws(
        SutProvider<ServiceAccountsController> sutProvider,
        AccessTokenCreateRequestModel data,
    ...
    )
    {
        sutProvider
            .GetDependency<IServiceAccountRepository>()
            .GetByIdAsync(serviceAccount.Id)
        ...
        sutProvider
            .GetDependency<ICreateAccessTokenCommand>()
            .CreateAsync(default)
            .ReturnsForAnyArgs(
                new ApiKeyClientSecretDetails { ApiKey = resultAccessToken, ClientSecret = mockClientSecret }
            );
    ...
    [Theory]
    [BitAutoData]
    public async Task CreateAccessToken_Success(
        SutProvider<ServiceAccountsController> sutProvider,
        AccessTokenCreateRequestModel data,
        ServiceAccount serviceAccount,
        string mockClientSecret
    )
    {
        ...
        await sutProvider.GetDependency<ICreateAccessTokenCommand>().Received(1).CreateAsync(Arg.Any<ApiKey>());
    }

    [Theory]
    [BitAutoData]
    public async Task GetAccessTokens_NoAccess_Throws(
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccount data,
    ...
    )
    {
        ...
        sutProvider
            .GetDependency<IAuthorizationService>()
            .AuthorizeAsync(Arg.Any<ClaimsPrincipal>(), data, Arg.Any<IEnumerable<IAuthorizationRequirement>>())
            .ReturnsForAnyArgs(AuthorizationResult.Failed());
        ...
        sutProvider
            ...
            .GetManyByServiceAccountIdAsync(default)
    ...
    [Theory]
    [BitAutoData]
    public async Task GetAccessTokens_Success(
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccount data,
        ICollection<ApiKey> resultApiKeys
    )
    ...
    [Theory]
    [BitAutoData]
    public async Task RevokeAccessTokens_NoAccess_Throws(
        SutProvider<ServiceAccountsController> sutProvider,
        RevokeAccessTokensRequest data,
        ServiceAccount serviceAccount
    )
    {
        sutProvider
        ...
        await sutProvider
            .GetDependency<IRevokeAccessTokensCommand>()
            .DidNotReceiveWithAnyArgs()
    ...
    [Theory]
    [BitAutoData]
    public async Task RevokeAccessTokens_Success(
        SutProvider<ServiceAccountsController> sutProvider,
        RevokeAccessTokensRequest data,
        ServiceAccount serviceAccount
    )
    ...
    [Theory]
    [BitAutoData]
    public async Task BulkDelete_NoServiceAccountsFound_ThrowsNotFound(
        SutProvider<ServiceAccountsController> sutProvider,
    ...
    )
    {
        ...
        sutProvider
            .GetDependency<IServiceAccountRepository>()
            .GetManyByIds(Arg.Is(ids))
            .ReturnsForAnyArgs(new List<ServiceAccount>());
        await Assert.ThrowsAsync<NotFoundException>(() => sutProvider.Sut.BulkDeleteAsync(ids));
        await sutProvider
            .GetDependency<IDeleteServiceAccountsCommand>()
            .DidNotReceiveWithAnyArgs()
            .DeleteServiceAccounts(Arg.Any<List<ServiceAccount>>());
    }

    [Theory]
    [BitAutoData]
    public async Task BulkDelete_ServiceAccountsFoundMisMatch_ThrowsNotFound(
        SutProvider<ServiceAccountsController> sutProvider,
        List<ServiceAccount> data,
    ...
    [Theory]
    [BitAutoData]
    public async Task BulkDelete_OrganizationMistMatch_ThrowsNotFound(
        SutProvider<ServiceAccountsController> sutProvider,
        List<ServiceAccount> data
    )
    {
    ...
    [Theory]
    [BitAutoData]
    public async Task BulkDelete_NoAccessToSecretsManager_ThrowsNotFound(
        SutProvider<ServiceAccountsController> sutProvider,
        List<ServiceAccount> data
    )
    {
        ...
        sutProvider
            ...
            .AccessSecretsManager(Arg.Is(organizationId))
    ...
    [Theory]
    [BitAutoData]
    public async Task BulkDelete_ReturnsAccessDeniedForProjectsWithoutAccess_Success(
        SutProvider<ServiceAccountsController> sutProvider,
        List<ServiceAccount> data
    )
    {
        ...
        foreach (var sa in data)
        {
            ...
            sutProvider
                .GetDependency<IAuthorizationService>()
                .AuthorizeAsync(Arg.Any<ClaimsPrincipal>(), sa, Arg.Any<IEnumerable<IAuthorizationRequirement>>())
                .ReturnsForAnyArgs(AuthorizationResult.Success());
        }
        sutProvider
            .GetDependency<IAuthorizationService>()
    ...
    private static void ArrangeCreateServiceAccountAutoScalingTest(
        int newSlotsRequired,
        SutProvider<ServiceAccountsController> sutProvider,
        ServiceAccountCreateRequestModel data,
        Organization organization
    )
    {
        sutProvider
            ...
            .AuthorizeAsync(
                Arg.Any<ClaimsPrincipal>(),
                data.ToServiceAccount(organization.Id),
                Arg.Any<IEnumerable<IAuthorizationRequirement>>()
            )
            .ReturnsForAnyArgs(AuthorizationResult.Success());
        sutProvider
            .GetDependency<IOrganizationRepository>()
            .GetByIdAsync(Arg.Is(organization.Id))
            .Returns(organization);
        sutProvider
            .GetDependency<ICountNewServiceAccountSlotsRequiredQuery>()
