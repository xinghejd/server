...
public class CloudSyncSponsorshipsCommandTests : FamiliesForEnterpriseTestsBase
{
    ...
    {
        var result = await sutProvider.Sut.SyncOrganization(
            organization,
            Enumerable.Empty<OrganizationSponsorshipData>()
        );
    ...
    [Theory]
    [BitAutoData]
    public async Task SyncOrganization_Success_RecordsEvent(
        Organization organization,
        SutProvider<CloudSyncSponsorshipsCommand> sutProvider
    )
    {
    ...
    [Theory]
    [BitAutoData]
    public async Task SyncOrganization_OneExisting_OneNew_Success(
        SutProvider<CloudSyncSponsorshipsCommand> sutProvider,
        Organization sponsoringOrganization,
        OrganizationSponsorship existingSponsorship,
        OrganizationSponsorship newSponsorship
    )
    {
        // Arrange
        ...
        sutProvider
            ...
            .Returns(new List<OrganizationSponsorship> { existingSponsorship });

        // Act
        var (syncData, toEmailSponsorships) = await sutProvider.Sut.SyncOrganization(
        ...
        await sutProvider
            ...
            .Received(1)
            .UpsertManyAsync(
                Arg.Is<IEnumerable<OrganizationSponsorship>>(sponsorships => sponsorships.Count() == 2)
            );
    ...
    [Theory]
    [BitAutoData]
    public async Task SyncOrganization_TwoToDelete_OneCanDelete_Success(
        SutProvider<CloudSyncSponsorshipsCommand> sutProvider,
        Organization sponsoringOrganization,
        OrganizationSponsorship canDeleteSponsorship,
        OrganizationSponsorship cannotDeleteSponsorship
    )
    {
        // Arrange
        sponsoringOrganization.PlanType = PlanType.EnterpriseAnnually;
        ...
        sutProvider
            .GetDependency<IOrganizationSponsorshipRepository>()
            .GetManyBySponsoringOrganizationAsync(sponsoringOrganization.Id)
            .Returns(new List<OrganizationSponsorship> { canDeleteSponsorship, cannotDeleteSponsorship });
        ...
        await sutProvider
            ...
            .Received(1)
            .DeleteManyAsync(
                Arg.Is<IEnumerable<Guid>>(toDeleteIds =>
    ...
    [Theory]
    [BitAutoData]
    public async Task SyncOrganization_BadData_DoesNotSave(
        SutProvider<CloudSyncSponsorshipsCommand> sutProvider,
        Organization sponsoringOrganization,
        OrganizationSponsorship badOrganizationSponsorship
    )
    {
        sponsoringOrganization.PlanType = PlanType.EnterpriseAnnually;
        ...
        var (syncData, toEmailSponsorships) = await sutProvider.Sut.SyncOrganization(
            sponsoringOrganization,
            new[] { new OrganizationSponsorshipData(badOrganizationSponsorship) }
        );
    ...
    [Theory]
    [BitAutoData]
    public async Task SyncOrganization_OrgDisabledForFourMonths_DoesNotSave(
        SutProvider<CloudSyncSponsorshipsCommand> sutProvider,
        Organization sponsoringOrganization,
    ...
    )
    {
        ...
        var (syncData, toEmailSponsorships) = await sutProvider.Sut.SyncOrganization(
            sponsoringOrganization,
            new[] { new OrganizationSponsorshipData(organizationSponsorship) }
        );
