...
public class UpdateSecretsManagerSubscriptionCommandTests
{
    ...
    )
    {
        ...
        var update = new SecretsManagerSubscriptionUpdate(organization, false) { MaxAutoscaleSmSeats = 3 };
    ...
    )
    {
        organization.PlanType = planType;
        organization.SmSeats = 2;
        var update = new SecretsManagerSubscriptionUpdate(organization, false) { MaxAutoscaleSmSeats = 2 };
