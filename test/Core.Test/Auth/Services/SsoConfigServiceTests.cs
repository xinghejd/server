...
{
    [Theory, BitAutoData]
    public async Task SaveAsync_ExistingItem_UpdatesRevisionDateOnly(
        SutProvider<SsoConfigService> sutProvider,
    ...
    )
    {
        ...
        sutProvider.GetDependency<ISsoConfigRepository>().UpsertAsync(ssoConfig).Returns(Task.CompletedTask);
    ...
    [Theory, BitAutoData]
    public async Task SaveAsync_NewItem_UpdatesCreationAndRevisionDate(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
    ...
    [Theory, BitAutoData]
    public async Task SaveAsync_PreventDisablingKeyConnector(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
        ...
        await sutProvider.GetDependency<ISsoConfigRepository>().DidNotReceiveWithAnyArgs().UpsertAsync(default);
    }
    ...
    [Theory, BitAutoData]
    public async Task SaveAsync_KeyConnector_SingleOrgNotEnabled_Throws(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
    ...
    [Theory, BitAutoData]
    public async Task SaveAsync_KeyConnector_SsoPolicyNotEnabled_Throws(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
        ...
        sutProvider
            ...
            .GetByOrganizationIdTypeAsync(Arg.Any<Guid>(), PolicyType.SingleOrg)
    ...
    [Theory, BitAutoData]
    public async Task SaveAsync_KeyConnector_SsoConfigNotEnabled_Throws(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
    ...
    [Theory, BitAutoData]
    public async Task SaveAsync_KeyConnector_KeyConnectorAbilityNotEnabled_Throws(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
    ...
    [Theory, BitAutoData]
    public async Task SaveAsync_KeyConnector_Success(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
        ...
        await sutProvider.GetDependency<ISsoConfigRepository>().ReceivedWithAnyArgs().UpsertAsync(default);
    }

    [Theory, BitAutoData]
    public async Task SaveAsync_Tde_Enable_Required_Policies(
        SutProvider<SsoConfigService> sutProvider,
        Organization organization
    )
    {
        ...
        await sutProvider
            .GetDependency<ISavePolicyCommand>()
            .Received(1)
            .SaveAsync(
                Arg.Is<PolicyUpdate>(t =>
                    t.Type == PolicyType.SingleOrg && t.OrganizationId == organization.Id && t.Enabled
                )
            );
        ...
        await sutProvider
            ...
            .SaveAsync(
                Arg.Is<PolicyUpdate>(t =>
                    t.Type == PolicyType.ResetPassword
        ...
        await sutProvider
            ...
            .SaveAsync(
                Arg.Is<PolicyUpdate>(t =>
                    t.Type == PolicyType.RequireSso && t.OrganizationId == organization.Id && t.Enabled
                )
            );
