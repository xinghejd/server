...
public class SetInitialMasterPasswordCommandTests
{
    ...
    )
    {
        ...
        sutProvider.GetDependency<IOrganizationRepository>().GetByIdentifierAsync(orgIdentifier).Returns(org);
    ...
    )
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>(
            async () =>
                await sutProvider.Sut.SetInitialMasterPasswordAsync(null, masterPassword, key, orgIdentifier)
        );
    }
    ...
    )
    {
        ...
        var exception = await Assert.ThrowsAsync<BadRequestException>(
            async () =>
                await sutProvider.Sut.SetInitialMasterPasswordAsync(user, masterPassword, key, orgSsoIdentifier)
        );
    ...
    )
    {
        ...
        sutProvider.GetDependency<IOrganizationRepository>().GetByIdentifierAsync(orgIdentifier).ReturnsNull();

        // Act & Assert
        var exception = await Assert.ThrowsAsync<BadRequestException>(
            async () =>
                await sutProvider.Sut.SetInitialMasterPasswordAsync(user, masterPassword, key, orgIdentifier)
        );
    ...
    )
    {
        ...
        sutProvider.GetDependency<IOrganizationRepository>().GetByIdentifierAsync(Arg.Any<string>()).Returns(org);
        ...
        var exception = await Assert.ThrowsAsync<BadRequestException>(
            async () =>
                await sutProvider.Sut.SetInitialMasterPasswordAsync(user, masterPassword, key, org.Identifier)
        );
    ...
    )
    {
        ...
        await sutProvider
            ...
            .DidNotReceive()
            .AcceptOrgUserAsync(Arg.Any<OrganizationUser>(), Arg.Any<User>(), Arg.Any<IUserService>());
    }
