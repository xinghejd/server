...
public class CollectionCustomization : ICustomization
{
    ...
    public void Customize(IFixture fixture)
    {
        ...
        fixture.Customize<Collection>(composer =>
            composer.With(o => o.OrganizationId, orgId).WithGuidFromSeed(c => c.Id, _collectionIdSeed)
        );

        fixture.Customize<CollectionDetails>(composer =>
            composer.With(o => o.OrganizationId, orgId).WithGuidFromSeed(cd => cd.Id, _collectionIdSeed)
        );
