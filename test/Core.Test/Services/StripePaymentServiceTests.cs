...
public class StripePaymentServiceTests
{
    ...
    public async Task PurchaseOrganizationAsync_Invalid(
    ...
    )
    {
        var exception = await Assert.ThrowsAsync<GatewayException>(
            () =>
                sutProvider.Sut.PurchaseOrganizationAsync(
                    null,
                    paymentMethodType,
                    null,
                    null,
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_Stripe_ProviderOrg_Coupon_Add(
        SutProvider<StripePaymentService> sutProvider,
    ...
    )
    {
        ...
        stripeAdapter.CustomerCreateAsync(default).ReturnsForAnyArgs(new Stripe.Customer { Id = "C-1" });
        stripeAdapter
            .SubscriptionCreateAsync(default)
            .ReturnsForAnyArgs(
                new Stripe.Subscription { Id = "S-1", CurrentPeriodEnd = DateTime.Today.AddDays(10) }
            );
        sutProvider.GetDependency<IGlobalSettings>().BaseServiceUri.CloudRegion.Returns("US");

        var result = await sutProvider.Sut.PurchaseOrganizationAsync(
            organization,
        ...
        await stripeAdapter
            .Received()
            .CustomerCreateAsync(
                Arg.Is<Stripe.CustomerCreateOptions>(c =>
        ...
        await stripeAdapter
            ...
            .SubscriptionCreateAsync(
                Arg.Is<Stripe.SubscriptionCreateOptions>(s =>
                    s.Customer == "C-1"
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_SM_Stripe_ProviderOrg_Coupon_Add(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo,
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_Stripe(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_Stripe_PM(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_Stripe_Declined(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_SM_Stripe_Declined(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_Stripe_RequiresAction(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_SM_Stripe_RequiresAction(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_Paypal(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_SM_Paypal(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
        ...
        await stripeAdapter
            ...
            .SubscriptionCreateAsync(
                Arg.Is<Stripe.SubscriptionCreateOptions>(s =>
                    ...
                    && s.Items.Count == 4
                    && s.Items.Count(i =>
                        i.Plan == plan.PasswordManager.StripeSeatPlanId && i.Quantity == additionalSeats
                    ) == 1
                    && s.Items.Count(i =>
                        i.Plan == plan.PasswordManager.StripeStoragePlanId && i.Quantity == additionalStorage
                    ) == 1
                    && s.Items.Count(i =>
                        i.Plan == plan.SecretsManager.StripeSeatPlanId && i.Quantity == additionalSmSeats
                    ) == 1
                    && s.Items.Count(i =>
                        i.Plan == plan.SecretsManager.StripeServiceAccountPlanId
                        && i.Quantity == additionalServiceAccounts
                    ) == 1
                )
            );
    }
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_Paypal_FailedCreate(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_SM_Paypal_FailedCreate(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task PurchaseOrganizationAsync_PayPal_Declined(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        string paymentToken,
        TaxInfo taxInfo
    ...
    [Theory, BitAutoData]
    public async Task UpgradeFreeOrganizationAsync_Success(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        TaxInfo taxInfo
    )
    {
        ...
        var stripeAdapter = sutProvider.GetDependency<IStripeAdapter>();
        stripeAdapter
            .CustomerGetAsync(default)
            .ReturnsForAnyArgs(
                new Stripe.Customer
                {
                    Id = "C-1",
                    Metadata = new Dictionary<string, string> { { "btCustomerId", "B-123" } },
                }
            );
        stripeAdapter
            .CustomerUpdateAsync(default)
            .ReturnsForAnyArgs(
                new Stripe.Customer
                {
                    Id = "C-1",
    ...
    [Theory, BitAutoData]
    public async Task UpgradeFreeOrganizationAsync_SM_Success(
        SutProvider<StripePaymentService> sutProvider,
        Organization organization,
        TaxInfo taxInfo
    )
    ...
    )
    {
        ...
        await stripeAdapter
            ...
            .CustomerUpdateAsync(
                ...
                Arg.Is<Stripe.CustomerUpdateOptions>(c =>
                    c.Address.Country == taxInfo.BillingAddressCountry
                    && c.Address.PostalCode == taxInfo.BillingAddressPostalCode
                    && c.Address.Line1 == taxInfo.BillingAddressLine1
                    && c.Address.Line2 == taxInfo.BillingAddressLine2
