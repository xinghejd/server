...
public class CloudICloudOrganizationSignUpCommandTests
{
    ...
    )
    {
        ...
        await sutProvider
            ...
            .Received(1)
            .CreateAsync(Arg.Is<OrganizationUser>(o => o.AccessSecretsManager == signup.UseSecretsManager));
        ...
        await sutProvider
            ...
            .CreateAsync(
                ...
                Arg.Is<IEnumerable<CollectionAccessSelection>>(cas =>
                    cas.Count() == 1
                    && cas.All(c => c.Id == orgUserId && !c.ReadOnly && !c.HidePasswords && c.Manage)
                )
            );
    ...
    public async Task SignUp_SM_Passes(
        PlanType planType,
        OrganizationSignup signup,
        SutProvider<CloudOrganizationSignUpCommand> sutProvider
    )
        ...
        await sutProvider
            ...
            .CreateAsync(
                Arg.Is<Organization>(o =>
                    ...
                    && o.SmServiceAccounts
                        == plan.SecretsManager.BaseServiceAccount + signup.AdditionalServiceAccounts
                )
            );
        await sutProvider
            .GetDependency<IOrganizationUserRepository>()
    ...
    [Theory]
    [BitAutoData(PlanType.EnterpriseAnnually)]
    public async Task SignUp_SM_Throws_WhenManagedByMSP(
        PlanType planType,
        OrganizationSignup signup,
        SutProvider<CloudOrganizationSignUpCommand> sutProvider
    )
    ...
    [Theory]
    [BitAutoData]
    public async Task SignUpAsync_SecretManager_AdditionalServiceAccounts_NotAllowedByPlan_ShouldThrowException(
        OrganizationSignup signup,
        SutProvider<CloudOrganizationSignUpCommand> sutProvider
    )
    {
    ...
    [Theory]
    [BitAutoData]
    public async Task SignUpAsync_InvalidateServiceAccount_ShouldThrowException(
        OrganizationSignup signup,
        SutProvider<CloudOrganizationSignUpCommand> sutProvider
    )
    {
