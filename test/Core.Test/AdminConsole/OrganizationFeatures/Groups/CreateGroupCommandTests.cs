...
public class CreateGroupCommandTests
{
    ...
    public async Task CreateGroup_Success(
        SutProvider<CreateGroupCommand> sutProvider,
    ...
    )
    {
        ...
        await sutProvider
            ...
            .Received(1)
            .RaiseEventAsync(
                Arg.Is<ReferenceEvent>(r =>
                    r.Type == ReferenceEventType.GroupCreated
    ...
    [Theory, OrganizationCustomize(UseGroups = true), BitAutoData]
    public async Task CreateGroup_WithCollections_Success(
        SutProvider<CreateGroupCommand> sutProvider,
        Organization organization,
        Group group,
    ...
    [Theory, OrganizationCustomize(UseGroups = true), BitAutoData]
    public async Task CreateGroup_WithEventSystemUser_Success(
        SutProvider<CreateGroupCommand> sutProvider,
        Organization organization,
        Group group,
    ...
    )
    {
        ...
        await sutProvider
            .GetDependency<IEventService>()
            .Received(1)
            .LogGroupEventAsync(group, Enums.EventType.Group_Created, eventSystemUser);
        await sutProvider
            .GetDependency<IReferenceEventService>()
            .Received(1)
            .RaiseEventAsync(
    ...
    [Theory, OrganizationCustomize(UseGroups = true), BitAutoData]
    public async Task CreateGroup_WithNullOrganization_Throws(
        SutProvider<CreateGroupCommand> sutProvider,
        Group group,
        EventSystemUser eventSystemUser
    )
    {
        var exception = await Assert.ThrowsAsync<BadRequestException>(
            async () => await sutProvider.Sut.CreateGroupAsync(group, null, eventSystemUser)
        );
    ...
    public async Task CreateGroup_WithUseGroupsAsFalse_Throws(
        SutProvider<CreateGroupCommand> sutProvider,
        Organization organization,
        Group group,
        EventSystemUser eventSystemUser
    ...
    {
        var exception = await Assert.ThrowsAsync<BadRequestException>(
            async () => await sutProvider.Sut.CreateGroupAsync(group, organization, eventSystemUser)
        );
