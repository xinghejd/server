...
public class RemoveOrganizationUserCommandTests
{
    ...
    )
    {
        ...
        sutProvider.GetDependency<ICurrentContext>().OrganizationOwner(deletingUser.OrganizationId).Returns(true);

        // Act
        await sutProvider.Sut.RemoveUserAsync(
        ...
        // Assert
        await sutProvider
            .GetDependency<IGetOrganizationUsersManagementStatusQuery>()
    ...
    )
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(
            async () => await sutProvider.Sut.RemoveUserAsync(organizationId, organizationUserId, null)
        );
    }
    ...
    )
    {
        ...
        sutProvider
            ...
            .Returns(new OrganizationUser { Id = organizationUserId, OrganizationId = Guid.NewGuid() });
    ...
    )
    {
        ...
        sutProvider
            ...
            .GetUsersOrganizationManagementStatusAsync(
                ...
                Arg.Is<IEnumerable<Guid>>(i => i.Contains(orgUser.Id))
            )
    ...
    )
    {
        // Act & Assert
        await Assert.ThrowsAsync<NotFoundException>(
            async () => await sutProvider.Sut.RemoveUserAsync(organizationId, organizationUserId, eventSystemUser)
        );
    }
    ...
    )
    {
        // Act & Assert
        await Assert.ThrowsAsync<NotFoundException>(
            async () => await sutProvider.Sut.RemoveUserAsync(organizationId, userId)
        );
    }
    ...
    )
    {
        ...
        // Act
        var result = await sutProvider.Sut.RemoveUsersAsync(
            deletingUser.OrganizationId,
            organizationUserIds,
            deletingUser.UserId
        );
        ...
        await sutProvider
            ...
            .LogOrganizationUserEventsAsync(
                Arg.Is<IEnumerable<(OrganizationUser OrganizationUser, EventType EventType, DateTime? DateTime)>>(
                    i =>
    ...
    [Theory, BitAutoData]
    public async Task RemoveUsers_WithDeletingUserId_WithMismatchingOrganizationId_ThrowsException(
        OrganizationUser organizationUser,
        OrganizationUser deletingUser,
        SutProvider<RemoveOrganizationUserCommand> sutProvider
    )
    {
        ...
        var exception = await Assert.ThrowsAsync<BadRequestException>(
            () =>
                sutProvider.Sut.RemoveUsersAsync(
                    deletingUser.OrganizationId,
                    organizationUserIds,
                    deletingUser.UserId
                )
    ...
    )
    {
        ...
        // Assert
        Assert.Contains(
            RemoveOrganizationUserCommand.RemoveOwnerByNonOwnerErrorMessage,
    ...
    public async Task RemoveUsers_WithDeletingUserId_RemovingManagedUser_WithAccountDeprovisioningEnabled_ThrowsException(
        [OrganizationUser(status: OrganizationUserStatusType.Confirmed, OrganizationUserType.User)]
    ...
    )
    {
        ...
        await sutProvider
            ...
            .LogOrganizationUserEventsAsync(
                Arg.Any<
                    IEnumerable<(OrganizationUser OrganizationUser, EventType EventType, DateTime? DateTime)>
                >()
            );
        Assert.Contains(
            RemoveOrganizationUserCommand.RemoveClaimedAccountErrorMessage,
            result.First().ErrorMessage
        );
    }
    ...
    public async Task RemoveUsers_WithDeletingUserId_LastOwner_ThrowsException(
        [OrganizationUser(status: OrganizationUserStatusType.Confirmed, OrganizationUserType.Owner)]
            OrganizationUser orgUser,
        SutProvider<RemoveOrganizationUserCommand> sutProvider
    )
    {
        ...
        await sutProvider
            ...
            .LogOrganizationUserEventsAsync(
                ...
                >(i =>
                    i.First().OrganizationUser.Id == orgUser1.Id
                    && i.Last().OrganizationUser.Id == orgUser2.Id
                    && i.All(u => u.EventSystemUser == eventSystemUser && u.DateTime == eventDate)
                )
            );
    }
    ...
    {
        return new SutProvider<RemoveOrganizationUserCommand>().WithFakeTimeProvider().Create();
    }
}
