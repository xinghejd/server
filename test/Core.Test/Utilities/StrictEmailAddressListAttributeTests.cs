...
{
    public static List<object[]> EmailList =>
        new()
        {
            new object[]
            {
                new List<string> { "test@domain.com", "test@sub.domain.com", "hello@world.planet.com" },
                true,
            },
            new object[]
            {
                new List<string> { "/hello@world.com", "hello@##world.pla   net.com", "''thello@world.com" },
                false,
            },
            new object[]
            {
                new List<string> { "/hello.com", "test@domain.com", "''thello@world.com" },
                false,
            },
            new object[]
            {
                new List<string> { "héllö@world.com", "hello@world.planet.com", "hello@world.planet.com" },
                false,
            },
            new object[]
            {
