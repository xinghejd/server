...
public class CollectionRepositoryTests
{
    ...
    public async Task GetByIdWithPermissionsAsync_WithRelationships_Success(
    ...
    )
    {
        ...
        var group = await groupRepository.CreateAsync(
            new Group { Name = "Test Group", OrganizationId = organization.Id }
        );
        ...
        var collectionWithPermissions = await collectionRepository.GetByIdWithPermissionsAsync(
            collection.Id,
            user.Id,
            true
        );
    ...
    /// </summary>
    [DatabaseTheory, DatabaseData]
    public async Task GetByIdWithPermissionsAsync_UserOverrideGroup_Success(
        IUserRepository userRepository,
        IOrganizationRepository organizationRepository,
        ICollectionRepository collectionRepository,
        IOrganizationUserRepository organizationUserRepository,
        ...
        await collectionRepository.CreateAsync(
            ...
            users: new[]
            {
                new CollectionAccessSelection()
                {
                    ...
                    HidePasswords = false,
                    ReadOnly = true,
                    Manage = false, // User is given ReadOnly (should override group)
                },
            }
        );
    ...
    /// </summary>
    [DatabaseTheory, DatabaseData]
    public async Task GetByIdWithPermissionsAsync_CombineGroupPermissions_Success(
        IUserRepository userRepository,
        IOrganizationRepository organizationRepository,
        ICollectionRepository collectionRepository,
        IOrganizationUserRepository organizationUserRepository,
    ...
    )
    {
        ...
        var group2 = await groupRepository.CreateAsync(
            new Group { Name = "Test Group 2", OrganizationId = organization.Id }
        );
        ...
        await collectionRepository.CreateAsync(
            ...
            groups: new[]
            {
                new CollectionAccessSelection
                {
                    ...
                    HidePasswords = false,
                    ReadOnly = true,
                    Manage = false, // Group 1 is ReadOnly
                },
                new CollectionAccessSelection
                {
                    Id = group2.Id,
                    HidePasswords = false,
                    ReadOnly = false,
                    Manage = true, // Group 2 is Manage
                },
            },
            users: new List<CollectionAccessSelection>()
        ); // No explicit user permissions for this test
    ...
    /// </summary>
    [DatabaseTheory, DatabaseData]
    public async Task GetManyByOrganizationIdWithPermissionsAsync_Success(
        IUserRepository userRepository,
        IOrganizationRepository organizationRepository,
        ICollectionRepository collectionRepository,
        IOrganizationUserRepository organizationUserRepository,
    ...
    )
    {
        ...
        var collections = await collectionRepository.GetManyByOrganizationIdWithPermissionsAsync(
            organization.Id,
            user.Id,
            true
        );
    ...
    /// </summary>
    [DatabaseTheory, DatabaseData]
    public async Task GetManyByOrganizationIdWithPermissionsAsync_GroupBy_Success(
        IUserRepository userRepository,
        IOrganizationRepository organizationRepository,
        ICollectionRepository collectionRepository,
        IOrganizationUserRepository organizationUserRepository,
    ...
    )
    {
        ...
        var orgUser1 = await organizationUserRepository.CreateAsync(
            new OrganizationUser
            {
                OrganizationId = organization.Id,
                UserId = user.Id,
        ...
        var orgUser2 = await organizationUserRepository.CreateAsync(
            new OrganizationUser
            {
                OrganizationId = organization.Id,
                UserId = user.Id,
        ...
        var orgUser3 = await organizationUserRepository.CreateAsync(
            new OrganizationUser
            {
                OrganizationId = organization.Id,
                UserId = user.Id,
        ...
        var group1 = await groupRepository.CreateAsync(
            new Group { Name = "Test Group #1", OrganizationId = organization.Id }
        );
        ...
        var group3 = await groupRepository.CreateAsync(
            new Group { Name = "Test Group #3", OrganizationId = organization.Id }
        );

        var collection = new Collection { Name = "Test Collection Name", OrganizationId = organization.Id };
        ...
        await collectionRepository.ReplaceAsync(
            collection,
            [
