...
public class OrganizationSubscriptionOptionsBase : SubscriptionCreateOptions
{
    ...
    )
    {
        ...
        Metadata = new Dictionary<string, string> { [org.GatewayIdField()] = org.Id.ToString() };
    ...
    private void AddPremiumAccessAddon(Plan plan, bool premiumAccessAddon)
    {
        ...
        {
            Items.Add(
                new SubscriptionItemOptions { Plan = plan.PasswordManager.StripePremiumAccessPlanId, Quantity = 1 }
            );
        }
    }
