...
public interface IMailService
{
    ...
    Task SendOrganizationMaxSeatLimitReachedEmailAsync(
    ...
    Task SendOrganizationAcceptedEmailAsync(
        Organization organization,
    ...
    Task SendEmergencyAccessRecoveryInitiated(
    ...
    Task SendFamiliesForEnterpriseOfferEmailAsync(
        string sponsorOrgName,
        string email,
        bool existingAccount,
        string token
    );
    Task BulkSendFamiliesForEnterpriseOfferEmailAsync(
        string SponsorOrgName,
    ...
    Task SendUnverifiedOrganizationDomainEmailAsync(
        IEnumerable<string> adminEmails,
        string organizationId,
        string domainName
    );
    Task SendSecretsManagerMaxSeatLimitReachedEmailAsync(
        Organization organization,
        int maxSeatCount,
        IEnumerable<string> ownerEmails
    );
    ...
    Task SendTrustedDeviceAdminApprovalEmailAsync(
        string email,
        DateTime utcNow,
        string ip,
    ...
    Task SendRequestSMAccessToAdminEmailAsync(
        IEnumerable<string> adminEmails,
        string organizationName,
        string userRequestingAccess,
        string emailContent
    );
    Task SendFamiliesForEnterpriseRemoveSponsorshipsEmailAsync(
        string email,
