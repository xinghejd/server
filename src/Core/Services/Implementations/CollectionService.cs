...
public class CollectionService : ICollectionService
{
    ...
    )
    {
        ...
        {
            throw new BadRequestException("At least one member or group must have can manage permission.");
        }
        ...
        if (collection.Id == default(Guid))
        {
            ...
            await _referenceEventService.RaiseEventAsync(
                new ReferenceEvent(ReferenceEventType.CollectionCreated, org, _currentContext)
            );
        }
        else
        {
