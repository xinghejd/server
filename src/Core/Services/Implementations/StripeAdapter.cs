...
public class StripeAdapter : IStripeAdapter
{
    ...
    public async Task<CustomerBalanceTransaction> CustomerBalanceTransactionCreate(
        string customerId,
    ...
    public Task<Stripe.Subscription> SubscriptionUpdateAsync(
        string id,
    ...
    public Task<Stripe.Subscription> SubscriptionCancelAsync(
        string Id,
        Stripe.SubscriptionCancelOptions options = null
    )
    {
    ...
    public IAsyncEnumerable<Stripe.PaymentMethod> PaymentMethodListAutoPagingAsync(
        Stripe.PaymentMethodListOptions options
    ) => _paymentMethodService.ListAutoPagingAsync(options);

    public Task<Stripe.PaymentMethod> PaymentMethodAttachAsync(
        string id,
    ...
    public Task<Stripe.PaymentMethod> PaymentMethodDetachAsync(
        string id,
    ...
    public Task<Stripe.TaxId> TaxIdDeleteAsync(
        string customerId,
        string taxIdId,
    ...
    public Task<Stripe.Card> CardDeleteAsync(
        string customerId,
        string cardId,
        Stripe.CardDeleteOptions options = null
    )
    {
        return _cardService.DeleteAsync(customerId, cardId, options);
    }

    public Task<Stripe.BankAccount> BankAccountCreateAsync(
        string customerId,
    ...
    public Task<Stripe.BankAccount> BankAccountDeleteAsync(
        string customerId,
        string bankAccount,
    ...
    public async Task<List<Stripe.TestHelpers.TestClock>> TestClockListAsync()
    {
        ...
        var options = new Stripe.TestHelpers.TestClockListOptions() { Limit = 100 };
