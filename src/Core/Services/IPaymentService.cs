...
public interface IPaymentService
{
    ...
    Task<string> PurchaseOrganizationAsync(
        Organization org,
    ...
    Task<string> PurchasePremiumAsync(
        User user,
        PaymentMethodType paymentMethodType,
        string paymentToken,
        short additionalStorageGb,
    ...
    Task<string> AdjustSeats(Provider provider, Plan plan, int currentlySubscribedSeats, int newlySubscribedSeats);
    Task<string> AdjustSmSeatsAsync(Organization organization, Plan plan, int additionalSeats);
    Task<string> AdjustStorageAsync(
    ...
    Task<string> AddSecretsManagerToSubscription(
        Organization org,
        Plan plan,
