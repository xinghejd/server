...
public interface IUserService
{
    ...
    Task<bool> CompleteWebAuthRegistrationAsync(
        User user,
        int value,
        string name,
    ...
    Task<IdentityResult> AdminResetPasswordAsync(
    ...
    Task<IdentityResult> ChangeKdfAsync(
        User user,
        string masterPassword,
        string newMasterPassword,
        string key,
    ...
    Task UpdateTwoFactorProviderAsync(
        User user,
    ...
    Task<Tuple<bool, string>> SignUpPremiumAsync(
        User user,
        string paymentToken,
    ...
    Task<UserLicense> GenerateLicenseAsync(
        User user,
    ...
    Task<IdentityResult> UpdatePasswordHash(
        User user,
        string newPassword,
