        ...
        ICustomTokenRequestValidator
{
    ...
    public async Task ValidateAsync(CustomTokenRequestValidationContext context)
    {
        ...
        {
            if (
                context.Result.ValidatedRequest.Client.Properties.TryGetValue("encryptedPayload", out var payload)
    ...
    )
    {
        ...
        var email =
            ...
            ?? context
                .Result.ValidatedRequest.ClientClaims?.FirstOrDefault(claim => claim.Type == JwtClaimTypes.Email)
                ?.Value;
    ...
    )
    {
        ...
        if (
            !context.Result.CustomResponse.TryGetValue("UserDecryptionOptions", out var userDecryptionOptionsObj)
