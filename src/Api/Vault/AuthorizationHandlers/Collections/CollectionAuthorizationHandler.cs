...
public class CollectionAuthorizationHandler : AuthorizationHandler<CollectionOperationRequirement>
{
    ...
    public CollectionAuthorizationHandler(ICurrentContext currentContext, IFeatureService featureService)
    {
    ...
    )
    {
        ...
        if (
            ...
            is { Type: OrganizationUserType.Owner or OrganizationUserType.Admin }
                ...
                or { Permissions.ManageGroups: true }
        )
        {
    ...
    private async Task CanReadAllWithAccessAsync(
        AuthorizationHandlerContext context,
        CollectionOperationRequirement requirement,
        CurrentContextOrganization? org
    )
