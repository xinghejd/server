...
public static class BulkCollectionOperations
{
    ...
    public static readonly BulkCollectionOperationRequirement ReadWithAccess = new()
    {
        Name = nameof(ReadWithAccess),
    };
    ...
    /// </summary>
    public static readonly BulkCollectionOperationRequirement ImportCiphers = new()
    {
        Name = nameof(ImportCiphers),
    };

    /// <summary>
    /// Create, update or delete user access (CollectionUser)
    /// </summary>
    public static readonly BulkCollectionOperationRequirement ModifyUserAccess = new()
    {
        Name = nameof(ModifyUserAccess),
    };

    /// <summary>
    /// Create, update or delete group access (CollectionGroup)
    /// </summary>
    public static readonly BulkCollectionOperationRequirement ModifyGroupAccess = new()
    {
        Name = nameof(ModifyGroupAccess),
    };
}
