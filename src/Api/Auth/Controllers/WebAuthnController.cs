...
public class WebAuthnController : Controller
{
    ...
    )
    {
        ...
        return new WebAuthnCredentialCreateOptionsResponseModel { Options = options, Token = token };
    }
    ...
    public async Task Post([FromBody] WebAuthnLoginCredentialCreateRequestModel model)
    {
        ...
        var success = await _createWebAuthnLoginCredentialCommand.CreateWebAuthnLoginCredentialAsync(
            user,
            model.Name,
            tokenable.Options,
    ...
    public async Task UpdateCredential([FromBody] WebAuthnLoginCredentialUpdateRequestModel model)
    {
        ...
        var (_, credential) = await _assertWebAuthnLoginCredentialCommand.AssertWebAuthnLoginCredential(
            tokenable.Options,
            model.DeviceResponse
        );
