...
public class OrganizationDomainController : Controller
{
    ...
    public async Task<ListResponseModel<OrganizationDomainResponseModel>> Get(Guid orgId)
    {
        ...
        var domains = await _getOrganizationDomainByOrganizationIdQuery.GetDomainsByOrganizationIdAsync(orgId);
    ...
    public async Task<OrganizationDomainResponseModel> Get(Guid orgId, Guid id)
    {
        ...
        var organizationDomain =
            await _getOrganizationDomainByIdAndOrganizationIdQuery.GetOrganizationDomainByIdOrganizationIdAsync(
                id,
                orgId
            );
    ...
    public async Task<OrganizationDomainResponseModel> Post(
        Guid orgId,
    ...
    public async Task<OrganizationDomainResponseModel> Verify(Guid orgId, Guid id)
    {
        ...
        organizationDomain = await _verifyOrganizationDomainCommand.UserVerifyOrganizationDomainAsync(
            organizationDomain
        );
    ...
    {
        var ssoResults = (
            await _organizationDomainRepository.GetVerifiedOrganizationDomainSsoDetailsAsync(model.Email)
        ).ToList();
