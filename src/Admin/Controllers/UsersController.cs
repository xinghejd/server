...
public class UsersController : Controller
{
    ...
    public async Task<IActionResult> Edit(Guid id, UserEditModel model)
    {
        ...
        if (_accessControlService.UserHasPermission(Permission.User_Premium_Edit) || canUpgradePremium)
        {
        ...
        if (_accessControlService.UserHasPermission(Permission.User_Licensing_Edit) || canUpgradePremium)
        {
