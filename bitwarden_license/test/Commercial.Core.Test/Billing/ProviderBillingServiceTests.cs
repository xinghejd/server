...
public class ProviderBillingServiceTests
{
    ...
    )
    {
        ...
        providerPlanRepository.GetByIdAsync(Arg.Is<Guid>(p => p == command.ProviderPlanId)).Returns(existingPlan);
    ...
    )
    {
        ...
        providerPlanRepository.GetByIdAsync(Arg.Is<Guid>(p => p == providerPlanId)).Returns(existingPlan);

        var stripeAdapter = sutProvider.GetDependency<IStripeAdapter>();
        stripeAdapter
            .ProviderSubscriptionGetAsync(Arg.Is(provider.GatewaySubscriptionId), Arg.Is(provider.Id))
            .Returns(
                new Subscription
                {
                    ...
                    Items = new StripeList<SubscriptionItem>
                    {
                        ...
                        [
                            new SubscriptionItem
                            {
                                ...
                                {
                                    Id = StaticStore
                                        .GetPlan(PlanType.EnterpriseAnnually)
                                        .PasswordManager.StripeProviderPortalSeatPlanId,
                                },
                                Quantity = 10,
                            },
                        ],
        ...
        var command = new ChangeProviderPlanCommand(
            providerPlanId,
    ...
    )
    {
        ...
        await sutProvider
            .GetDependency<ISubscriberService>()
    ...
    )
    {
        ...
        var providerCustomer = new Customer
        {
            ...
            TaxIds = new StripeList<TaxId> { Data = [new TaxId { Type = "TYPE", Value = "VALUE" }] },
        };
        ...
        sutProvider
            ...
            .GetCustomerOrThrow(
                provider,
                Arg.Is<CustomerGetOptions>(options => options.Expand.FirstOrDefault() == "tax_ids")
            )
        ...
        sutProvider
            ...
            .BaseServiceUri.Returns(
                new Bit.Core.Settings.GlobalSettings.BaseServiceUriSettings(new Bit.Core.Settings.GlobalSettings())
                {
                    CloudRegion = "US",
                }
            );
        ...
        await sutProvider
            ...
            .Received(1)
            .ReplaceAsync(Arg.Is<Organization>(org => org.GatewayCustomerId == "customer_id"));
    }
    ...
    )
    {
        ...
        sutProvider
            .GetDependency<IProviderInvoiceItemRepository>()
    ...
    )
    {
        ...
        await sutProvider
            .GetDependency<IProviderPlanRepository>()
            .Received(1)
            .ReplaceAsync(Arg.Is<ProviderPlan>(pPlan => pPlan.AllocatedSeats == 60));
    }
    ...
    )
    {
        ...
        await sutProvider
            ...
            .Received(1)
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(pPlan =>
                    pPlan.Id == providerPlan.Id && pPlan.PurchasedSeats == 5 && pPlan.AllocatedSeats == 105
                )
            );
    }
    ...
    )
    {
        ...
        await sutProvider
            .GetDependency<IPaymentService>()
            .Received(1)
            .AdjustSeats(provider, StaticStore.GetPlan(providerPlan.PlanType), 110, 120);
        ...
        await sutProvider
            ...
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(pPlan =>
                    pPlan.Id == providerPlan.Id && pPlan.PurchasedSeats == 20 && pPlan.AllocatedSeats == 120
                )
            );
    }
    ...
    )
    {
        ...
        await sutProvider
            ...
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(pPlan =>
                    pPlan.Id == providerPlan.Id && pPlan.PurchasedSeats == 0 && pPlan.AllocatedSeats == 80
                )
            );
    }
    ...
    )
    {
        ...
        var result = await sutProvider.Sut.SeatAdjustmentResultsInPurchase(provider, planType, seatAdjustment);
    ...
    )
    {
        ...
        stripeAdapter
            .CustomerCreateAsync(
                Arg.Is<CustomerCreateOptions>(o =>
    ...
    )
    {
        ...
        sutProvider
            ...
            .SubscriptionCreateAsync(
                Arg.Is<SubscriptionCreateOptions>(sub =>
                    ...
                    && sub.Items.ElementAt(1).Price
                        == enterprisePlan.PasswordManager.StripeProviderPortalSeatPlanId
    ...
    )
    {
        ...
        var command = new UpdateProviderSeatMinimumsCommand(
            provider.Id,
            provider.GatewaySubscriptionId,
            [(PlanType.TeamsMonthly, -10), (PlanType.EnterpriseMonthly, 50)]
        );

        // Act
        var actual = await Assert.ThrowsAsync<BadRequestException>(
            () => sutProvider.Sut.UpdateSeatMinimums(command)
        );
    ...
    )
    {
        ...
        var enterprisePriceId = StaticStore
            .GetPlan(PlanType.EnterpriseMonthly)
            .PasswordManager.StripeProviderPortalSeatPlanId;
        var teamsPriceId = StaticStore
            .GetPlan(PlanType.TeamsMonthly)
            .PasswordManager.StripeProviderPortalSeatPlanId;
        ...
        stripeAdapter
            .ProviderSubscriptionGetAsync(provider.GatewaySubscriptionId, provider.Id)
        ...
        var command = new UpdateProviderSeatMinimumsCommand(
            provider.Id,
            provider.GatewaySubscriptionId,
            [(PlanType.EnterpriseMonthly, 30), (PlanType.TeamsMonthly, 20)]
        );
        ...
        await providerPlanRepository
            .Received(1)
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(providerPlan =>
                    providerPlan.PlanType == PlanType.EnterpriseMonthly && providerPlan.SeatMinimum == 30
                )
            );
        ...
        await providerPlanRepository
            ...
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(providerPlan =>
                    providerPlan.PlanType == PlanType.TeamsMonthly
                    && providerPlan.SeatMinimum == 20
                    && providerPlan.PurchasedSeats == 5
                )
            );
    ...
    )
    {
        ...
        var command = new UpdateProviderSeatMinimumsCommand(
            provider.Id,
            provider.GatewaySubscriptionId,
            [(PlanType.EnterpriseMonthly, 70), (PlanType.TeamsMonthly, 50)]
        );
        ...
        await providerPlanRepository
            ...
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(providerPlan =>
                    providerPlan.PlanType == PlanType.EnterpriseMonthly && providerPlan.SeatMinimum == 70
                )
            );
        ...
        await providerPlanRepository
            ...
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(providerPlan =>
                    providerPlan.PlanType == PlanType.TeamsMonthly && providerPlan.SeatMinimum == 50
                )
            );
    ...
    )
    {
        ...
        var command = new UpdateProviderSeatMinimumsCommand(
            provider.Id,
            provider.GatewaySubscriptionId,
            [(PlanType.EnterpriseMonthly, 60), (PlanType.TeamsMonthly, 60)]
        );
        ...
        await providerPlanRepository
            ...
            .ReplaceAsync(
                Arg.Is<ProviderPlan>(providerPlan =>
                    ...
                    && providerPlan.SeatMinimum == 60
                    && providerPlan.PurchasedSeats == 10
                )
            );
    ...
    )
    {
        ...
        var command = new UpdateProviderSeatMinimumsCommand(
            provider.Id,
            provider.GatewaySubscriptionId,
            [(PlanType.EnterpriseMonthly, 80), (PlanType.TeamsMonthly, 80)]
        );
    ...
    )
    {
        ...
        var command = new UpdateProviderSeatMinimumsCommand(
            provider.Id,
            provider.GatewaySubscriptionId,
            [(PlanType.EnterpriseMonthly, 70), (PlanType.TeamsMonthly, 30)]
        );
        ...
        await providerPlanRepository
            .DidNotReceive()
            .ReplaceAsync(Arg.Is<ProviderPlan>(providerPlan => providerPlan.PlanType == PlanType.TeamsMonthly));
