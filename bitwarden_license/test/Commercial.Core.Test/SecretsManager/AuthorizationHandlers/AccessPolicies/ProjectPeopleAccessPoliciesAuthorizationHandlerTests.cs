...
public class ProjectPeopleAccessPoliciesAuthorizationHandlerTests
{
    ...
    )
    {
        ...
        sutProvider
            ...
            .AccessToProjectAsync(resource.Id, userId, accessClientType)
            .Returns((read, write));
    }
    ...
    {
        var publicStaticFields = typeof(ProjectPeopleAccessPoliciesOperations).GetFields(
    ...
    public async Task ReplaceProjectPeople_UserNotInOrg_DoesNotSucceed(
    ...
    [BitAutoData(AccessClientType.User)]
    [BitAutoData(AccessClientType.NoAccessCheck)]
    public async Task ReplaceProjectPeople_GroupNotInOrg_DoesNotSucceed(
        AccessClientType accessClient,
        SutProvider<ProjectPeopleAccessPoliciesAuthorizationHandler> sutProvider,
        ProjectPeopleAccessPolicies resource,
        ClaimsPrincipal claimsPrincipal,
    ...
    public async Task ReplaceProjectPeople_AccessCheck(
        AccessClientType accessClient,
        bool read,
        bool write,
        bool expected,
