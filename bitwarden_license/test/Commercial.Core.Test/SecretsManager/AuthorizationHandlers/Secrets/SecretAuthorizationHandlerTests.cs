...
public class SecretAuthorizationHandlerTests
{
    private static void SetupPermission(
        SutProvider<SecretAuthorizationHandler> sutProvider,
    ...
    )
    {
        ...
        sutProvider
            ...
            .ProjectsAreInOrganization(default, default)
        ...
        switch (permissionType)
        {
            ...
            case PermissionType.RunAsUserWithPermission:
                sutProvider
                    .GetDependency<IAccessClientQuery>()
                    .GetAccessClientAsync(default, organizationId)
                    .ReturnsForAnyArgs((clientType, userId));
                break;
    ...
    {
        sutProvider.GetDependency<ICurrentContext>().AccessSecretsManager(secret.OrganizationId).Returns(true);
        var requirements = typeof(SecretOperations)
    ...
    public async Task CanCreateSecret_NotSupportedClientTypes_DoesNotSucceed(
    ...
    )
    {
        ...
        sutProvider
            .GetDependency<IProjectRepository>()
            .AccessToProjectAsync(secret.Projects!.FirstOrDefault()!.Id, userId, Arg.Any<AccessClientType>())
            .Returns((true, true));
        var authzContext = new AuthorizationHandlerContext(
            new List<IAuthorizationRequirement> { requirement },
            claimsPrincipal,
    ...
    [Theory]
    [BitAutoData]
    public async Task CanCreateSecret_WithoutProjectAdmin_Success(
        SutProvider<SecretAuthorizationHandler> sutProvider,
        Secret secret,
        Guid userId,
        ClaimsPrincipal claimsPrincipal
    ...
    public async Task CanCreateSecret_DoesNotSucceed(
        PermissionType permissionType,
        bool read,
        bool write,
        SutProvider<SecretAuthorizationHandler> sutProvider,
    ...
    public async Task CanCreateSecret_Success(
        PermissionType permissionType,
        bool read,
        bool write,
        SutProvider<SecretAuthorizationHandler> sutProvider,
    ...
    public async Task CanReadSecret_AccessCheck(
        PermissionType permissionType,
        bool read,
        bool write,
        bool expected,
    ...
    [Theory]
    [BitAutoData(AccessClientType.Organization)]
    public async Task CanUpdateSecret_NotSupportedClientTypes_DoesNotSucceed(
        AccessClientType clientType,
        SutProvider<SecretAuthorizationHandler> sutProvider,
        Secret secret,
        Guid userId,
    ...
    )
    {
        ...
        sutProvider
            .GetDependency<ISecretRepository>()
            .AccessToSecretAsync(secret.Id, Arg.Any<Guid>(), Arg.Any<AccessClientType>())
            .Returns((true, true));
        var authzContext = new AuthorizationHandlerContext(
            new List<IAuthorizationRequirement> { requirement },
            claimsPrincipal,
    ...
    [Theory]
    [BitAutoData]
    public async Task CanUpdateSecret_ClearProjectsAdmin_Success(
        SutProvider<SecretAuthorizationHandler> sutProvider,
        Secret secret,
        Guid userId,
        ClaimsPrincipal claimsPrincipal
    ...
    [BitAutoData(PermissionType.RunAsServiceAccountWithPermission, true, true, true)]
    public async Task CanUpdateSecret_NoProjectChanges_ReturnsExpected(
        PermissionType permissionType,
        bool read,
        bool write,
        bool expected,
    ...
    public async Task CanUpdateSecret_DoesNotSucceed(
        PermissionType permissionType,
        bool read,
        bool write,
        bool projectRead,
    ...
    [BitAutoData(PermissionType.RunAsServiceAccountWithPermission, true, true)]
    [BitAutoData(PermissionType.RunAsServiceAccountWithPermission, false, true)]
    public async Task CanUpdateSecret_Success(
        PermissionType permissionType,
        bool read,
        bool write,
        SutProvider<SecretAuthorizationHandler> sutProvider,
    ...
    [BitAutoData(PermissionType.RunAsServiceAccountWithPermission, true, false, false)]
    [BitAutoData(PermissionType.RunAsServiceAccountWithPermission, true, true, true)]
    public async Task CanDeleteSecret_AccessCheck(
        PermissionType permissionType,
        bool read,
        bool write,
        bool expected,
    ...
    [BitAutoData(PermissionType.RunAsUserWithPermission, true, false, false)]
    [BitAutoData(PermissionType.RunAsUserWithPermission, true, true, true)]
    public async Task CanReadAccessPolicies_AccessCheck(
        PermissionType permissionType,
        bool read,
        bool write,
        bool expected,
