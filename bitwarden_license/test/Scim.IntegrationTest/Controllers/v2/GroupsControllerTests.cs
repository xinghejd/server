...
public class GroupsControllerTests : IClassFixture<ScimApplicationFactory>, IAsyncLifetime
{
    ...
    public async Task Get_Success()
    {
        ...
        var responseModel = JsonSerializer.Deserialize<ScimGroupResponseModel>(
    ...
    public async Task GetList_Success()
    {
        ...
        var responseModel = JsonSerializer.Deserialize<ScimListResponseModel<ScimGroupResponseModel>>(
            context.Response.Body,
            new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase }
        );
        AssertHelper.AssertPropertyEqual(expectedResponse, responseModel);
    ...
    public async Task Post_Success()
    {
        ...
        var inputModel = new ScimGroupRequestModel
        {
            ...
            {
                new ScimGroupRequestModel.GroupMembersModel
                {
                    Display = "user1@example.com",
                    Value = ScimApplicationFactory.TestOrganizationUserId1.ToString(),
                },
            },
            Schemas = new List<string>() { ScimConstants.Scim2SchemaGroup },
        };
        ...
        Assert.True(
            databaseContext.GroupUsers.Any(gu =>
                gu.GroupId == responseModel.Id
                && gu.OrganizationUserId == ScimApplicationFactory.TestOrganizationUserId1
            )
        );
    }
    ...
    public async Task Put_ChangeNameAndMembers_Success()
    {
        ...
        var inputModel = new ScimGroupRequestModel
        {
            ...
            Members = new List<ScimGroupRequestModel.GroupMembersModel>
            {
                new ScimGroupRequestModel.GroupMembersModel
                {
                    ...
                    Value = ScimApplicationFactory.TestOrganizationUserId2.ToString(),
                },
                new ScimGroupRequestModel.GroupMembersModel
                {
                    Display = "user3@example.com",
                    Value = ScimApplicationFactory.TestOrganizationUserId3.ToString(),
                },
            },
            Schemas = new List<string>() { ScimConstants.Scim2SchemaGroup },
        };
        ...
        Assert.NotNull(
            databaseContext.GroupUsers.FirstOrDefault(gu =>
                gu.GroupId == groupId && gu.OrganizationUserId == ScimApplicationFactory.TestOrganizationUserId2
            )
        );
        Assert.NotNull(
            databaseContext.GroupUsers.FirstOrDefault(gu =>
                gu.GroupId == groupId && gu.OrganizationUserId == ScimApplicationFactory.TestOrganizationUserId3
            )
        );
    }
    ...
    public async Task Patch_ReplaceDisplayName_Success()
    {
        ...
        Assert.True(
            databaseContext.GroupUsers.Any(gu =>
                gu.OrganizationUserId == ScimApplicationFactory.TestOrganizationUserId4
            )
        );
    }
        ...
        var inputModel = new ScimPatchModel
        {
            Operations = new List<ScimPatchModel.OperationModel>()
            {
                new ScimPatchModel.OperationModel
                {
                    ...
                    Path = "members",
                    Value = JsonDocument
                        .Parse($"[{{\"value\":\"{ScimApplicationFactory.TestOrganizationUserId2}\"}}]")
                        .RootElement,
                },
            },
            Schemas = new List<string>() { ScimConstants.Scim2SchemaGroup },
    ...
    public async Task Patch_AddSingleMember_Success()
    {
        ...
        Assert.True(
            databaseContext.GroupUsers.Any(gu =>
                gu.GroupId == groupId && gu.OrganizationUserId == ScimApplicationFactory.TestOrganizationUserId1
            )
        );
        Assert.True(
            databaseContext.GroupUsers.Any(gu =>
        ...
        Assert.True(
            databaseContext.GroupUsers.Any(gu =>
                gu.GroupId == groupId && gu.OrganizationUserId == ScimApplicationFactory.TestOrganizationUserId4
            )
        );
    }
        ...
        var inputModel = new ScimPatchModel
        {
            Operations = new List<ScimPatchModel.OperationModel>()
            {
                new ScimPatchModel.OperationModel
                {
                    ...
                    Value = JsonDocument
                        .Parse(
                            $"[{{\"value\":\"{ScimApplicationFactory.TestOrganizationUserId2}\"}},{{\"value\":\"{ScimApplicationFactory.TestOrganizationUserId3}\"}}]"
                        )
                        .RootElement,
                },
            },
        ...
        var inputModel = new ScimPatchModel
        {
            Operations = new List<ScimPatchModel.OperationModel>()
            {
                new ScimPatchModel.OperationModel
                {
                    ...
                    Value = JsonDocument
                        .Parse(
                            $"[{{\"value\":\"{ScimApplicationFactory.TestOrganizationUserId1}\"}}, {{\"value\":\"{ScimApplicationFactory.TestOrganizationUserId4}\"}}]"
                        )
                        .RootElement,
                },
            },
