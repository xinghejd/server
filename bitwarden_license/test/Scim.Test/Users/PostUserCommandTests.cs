...
public class PostUserCommandTests
{
    ...
    public async Task PostUser_Success(
        ...
        string externalId,
        Guid organizationId,
        List<BaseScimUserModel.EmailModel> emails,
    ...
    [Theory]
    [BitAutoData]
    public async Task PostUser_Inactive_Throws(
        SutProvider<PostUserCommand> sutProvider,
        Guid organizationId,
        List<BaseScimUserModel.EmailModel> emails
    )
    ...
    [Theory]
    [BitAutoData]
    public async Task PostUser_DuplicateExternalId_Throws(
        SutProvider<PostUserCommand> sutProvider,
        Guid organizationId,
        List<BaseScimUserModel.EmailModel> emails,
        ICollection<OrganizationUserUserDetails> organizationUsers
    ...
    [Theory]
    [BitAutoData]
    public async Task PostUser_DuplicateUserName_Throws(
        SutProvider<PostUserCommand> sutProvider,
        Guid organizationId,
        List<BaseScimUserModel.EmailModel> emails,
        ICollection<OrganizationUserUserDetails> organizationUsers
